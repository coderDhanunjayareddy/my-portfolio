...
const techStack = [
  ...
  },
  {
    ...
    langName:"Java",
    langDesc:"<li>Java is a high-level, object-oriented programming language designed to have as few implementation dependencies as possible. It supports platform independence through its 'write once, run anywhere' capability, automatic memory management, and a robust standard library.</li>",
  },
];
